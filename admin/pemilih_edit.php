          ...
          <div class="box-body">
            <form action="pemilih_update.php" method="post">
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  <label>Prodi</label>
                  <input type="text" class="form-control" name="prodi" required="required" placeholder="Masukkan prodi .." value="<?php echo $d['pemilih_prodi'] ?>">
                </div>

                <div class="form-group">
                  <label>Semester</label>
                  <input type="text" class="form-control" name="semester" required="required" placeholder="Masukkan semester .." value=" <?php echo $d['pemilih_semester'] ?> ">
                </div>
                ...
                <div class="form-group">
                  <label>NIM</label>
                  <input type="text" class="form-control" name="nim" required="required" placeholder="Masukkan nim .." value="<?php echo $d['pemilih_nim'] ?>">
                </div>
