            ...
            <form action="user_update.php" method="post" enctype="multipart/form-data">
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="password" min="5" placeholder="Kosong Jika tidak ingin di ganti">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" required="required" name="level">
                    ...
                    <option <?php if($d['user_level'] == "panitia"){ echo "selected='selected'"; } ?> value="panitia">Panitia</option>
                  </select>
                </div>
