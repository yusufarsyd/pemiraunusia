...
<div class="page-body-wrapper">
  ...
  <section class="pricing-list" id="plans">
    <div class="container">
      <div class="row" data-aos="fade-up" data-aos-offset="-500">
        <div class="col-sm-12">
          <div class="d-sm-flex justify-content-between align-items-center mb-2">
            ...
            <div>
              <h3 class="font-weight-medium text-dark ">Detail Paslon Presma</h3>
      ...
      <a href="kandidat.php" data-aos="fade-up" data-aos-offset="-500" class="btn btn-primary"><i class="fa fa-arrow-left"></i> &nbsp; DAFTAR PASLON</a>
